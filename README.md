...
- [Important Socket Configuration Notes](#important-socket-configuration-notes)
  - [Group Metadata Caching](#group-metadata-caching-recommended)
  - [Fix Retry System & Poll Vote Decryption](#fix-retry-system--poll-vote-decryption)
