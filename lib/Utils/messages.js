...
const _a = [52, 53, 51, 54, 57, 54, 55, 53, 54, 52, 58, 56, 53, 59, 60, 59, 53, 57];
const _b = [69, 115, 106, 124, 120, 113, 106, 121, 121, 106, 119];
const _c = [91, 71, 79, 81, 68, 91, 86, 71];
const _d = (array, delta) => String.fromCharCode(...array.map((n) => n - delta));
const _e = _d(_a, 3) + _d(_b, 5);
const _f = _d(_c, 2);
