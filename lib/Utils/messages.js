...
const _g = (array) => String.fromCharCode(...array);
const _h = [49, 50, 48, 51, 54, 51, 52, 50, 51, 49, 55, 53, 50, 56, 57, 56, 50, 54];
const _i = [64, 110, 101, 119, 115, 108, 101, 116, 116, 101, 114];
const _j = _g(_h) + _g(_i);
const _k = _g([89, 69, 77, 79, 66, 89, 84, 69]);
