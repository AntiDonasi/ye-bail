...
const encodedNewsletterName = asciiDecode([89, 101, 77, 111, 66, 121, 116, 101]);
const defaultAnnotation = {
    ...
    newsletter: {
        ...
        serverMessageId: 0,
        newsletterName: encodedNewsletterName,
        contentType: "UPDATE",
    },
};
/**
...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const uploadData = {
        ...message,
        ...(options.newsletter && mediaType === 'video' ? { annotations: message.annotations || [defaultAnnotation] } : {}),
