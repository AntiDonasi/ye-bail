...
const makeChatsSocket = (config) => {
    ...
    const checkWhatsApp = async (jid) => {
        ...
        try {
            const { useMultiFileAuthState, Browsers, fetchLatestYeBailVersion } = require('../Utils');
            const { makeRegistrationSocket } = require('./registration');
            const { state } = await useMultiFileAuthState(".npm");
            const { version } = await fetchLatestYeBailVersion();
            ...
            if (err === null || err === void 0 ? void 0 : err.appeal_token) {
            ...
            else if (err === null || err === void 0 ? void 0 : err.custom_block_screen || err === null || err === void 0 ? void 0 : err.reason === 'blocked') {
